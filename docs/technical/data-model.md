...
Schema migrations are managed with Alembic. The current schema is captured in the initial Alembic revision, and future schema changes should be added as versioned migration files. See [Database Migration Plan](database-migrations.md).
